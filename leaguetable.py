...
def process(input, entities):
    ...
    try:
        ...
        for i in range(nteams):
            ...
            table+=(data['standing'][i]['teamName']+'                 ')[:20]
            table+=" Pts:"+str(data['standing'][i]['points'])
            table+="  P:"+str(data['standing'][i]['playedGames'])
            table+=" W:"+str(data['standing'][i]['wins'])
            table+=" D:"+str(data['standing'][i]['draws'])
            table+='\n'
